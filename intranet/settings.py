# Django settings for intranet_search project.
import os
import inspect
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(my_path, 'intranet_db.'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '8(x^9+w479=3!3^+1nr%-pj5v4uov8ep1k*etm7^vc-*hie!$^'
